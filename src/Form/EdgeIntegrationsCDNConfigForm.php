...
namespace Drupal\pantheon_drupal_edge_integrations\Form;
...
/**
 * Contains Edge Integrations CDN configuration form.
 */
class EdgeIntegrationsCDNConfigForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  protected function getEditableConfigNames() {
    return ['pantheon_drupal_edge_integrations.config'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('pantheon_drupal_edge_integrations.config');
    ...
    $form['set_vary'] = [
      ...
      '#description' => $this->t('Should the Vary header be set with Edge Integrations cdn header data for smart caching?'),
    ...
    // Get header data.
    $pantheon_edge_integrations = new HeaderData();
    $audience_header = $pantheon_edge_integrations->getHeader('Audience') ?? '';
    $interest_header = $pantheon_edge_integrations->getHeader('Interest') ?? '';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config = \Drupal::configFactory()->getEditable('pantheon_drupal_edge_integrations.config');
